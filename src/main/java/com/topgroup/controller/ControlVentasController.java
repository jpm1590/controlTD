package com.topgroup.controller;
...
import com.topgroup.model.DateModel;
...
public class ControlVentasController {
	...
	public ModelAndView request3(@PathVariable("date") String date) {
		...
		mav.addObject("processes", controlVentasService.getErrorsDesc(date, 1));
		mav.addObject("processes_easy", controlVentasService.getErrorsDesc(date, 2));
		mav.addObject("ver_app", controlVentasService.versionApp());
		mav.addObject("user_dir", System.getProperty("user.dir"));
		mav.addObject("img_web", "../imgs/topgroup_web.jpg");
